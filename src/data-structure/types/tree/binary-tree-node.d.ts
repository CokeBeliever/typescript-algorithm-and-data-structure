 ...
 * 二叉树结点接口 (二叉链表)
 */
export interface BinaryTreeNodeByBinaryLinkedListInterface<T, Element> {
  /** 当前结点的数据 */
  data: Element;
  /** 左子结点的指针 */
  left: T | null;
 ...
 * 二叉树结点接口 (三叉链表)
 */
export interface BinaryTreeNodeByTridentLinkedListInterface<T, Element> {
  /** 当前结点的数据 */
  data: Element;
  /** 左子结点的指针 */
  left: T | null;
 ...
 */
export type BinaryTreeOrderCallbackType<T> = (node: T) => void;

/**
 * 二叉树结点接口
 */
export interface BinaryTreeNodeInterface<T, Element>
